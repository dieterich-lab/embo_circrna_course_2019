...
#mkdir -pv /tmp/${TMP_RND}_${target}
#mkdir -pv /tmp/${TMP_RND}_${target}_mate1
#mkdir -pv /tmp/${TMP_RND}_${target}_mate2
...
STAR	--runThreadN 8\
	...
	--outTmpDir /tmp/${TMP_RND}_${target}/\
	--readFilesIn $2 $3\
...
STAR	--runThreadN 8\
	--genomeDir $1\
	--genomeLoad NoSharedMemory\
	--outTmpDir /tmp/${TMP_RND}_${target}_mate1/\
...
STAR	--runThreadN 8\
	--genomeDir $1\
	--genomeLoad NoSharedMemory\
	--outTmpDir /tmp/${TMP_RND}_${target}_mate2/\
...
rm /tmp/${TMP_RND}_${target}/ -rf
rm /tmp/${TMP_RND}_${target}_mate1/ -rf
rm /tmp/${TMP_RND}_${target}_mate2/ -rf
